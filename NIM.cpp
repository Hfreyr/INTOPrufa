...
using namespace std;
// fæ ekki draslið til að git push origin master eða til að git commit -a -m "My first git commit"  fæ alltaf upp finn ekki út úr þessu  fatal: Not a git repository (or any of the parent directories): .git   einhver lausn á þessu 
